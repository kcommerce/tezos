...
alphabet (see also the :ref:`kinds of address prefixes in Tezos <address_prefixes_jakarta>`).
...
In order to ensure that layer-2 transfers and :ref:`ticket withdrawals <withdrawals_jakarta>` are
...
any :ref:`ticket withdrawals <withdrawals_jakarta>` generated by the message.
...
#. Committed: During this stage, commitments can be :ref:`rejected <rejected_jakarta>`, moving
   ...
   :ref:`rejected <rejected_jakarta>`.  The "finalize" operation removes the inbox from the
   context.
